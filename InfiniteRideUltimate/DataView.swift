...
struct DataView:View{
    ...
    var body:some View{NavigationStack{ScrollView{VStack(alignment:.leading,spacing:12){
        Text("RIDE HISTORY").font(.title.weight(.black));Button(action:{importing=true}){Label("IMPORT FIT / GPX / TCX / CSV",systemImage:"square.and.arrow.down.fill").frame(maxWidth:.infinity)}.buttonStyle(.borderedProminent)
